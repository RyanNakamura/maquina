  ...
  <div class="min-h-screen bg-white">
    ...
    <header class="bg-white shadow-sm px-4 py-3">
      <div class="max-w-6xl mx-auto flex items-center justify-between">
        <img src="https://primeirodollar.store/lovable-uploads/eletroprime-logo-new-DSU3K9vw.png" alt="EletroPrime" class="h-8">
    ...
    <div class="max-w-6xl mx-auto px-4 py-8">
      <div class="grid md:grid-cols-2 gap-8 items-center">
        <div>
          <img src="https://primeirodollar.store/lovable-uploads/14337539-3779-44f4-a544-8066ecaabd64.png" alt="Kit de Furadeira Multifuncional" class="w-full rounded-lg shadow-lg">
        </div>
        <div>
    ...
    <div class="bg-gray-50 py-12">
      <div class="max-w-6xl mx-auto px-4">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
          <img src="https://primeirodollar.store/lovable-uploads/3050a206-4579-44ff-98a6-ab8d93ec9242.png" alt="Furadeira" class="w-full rounded-lg shadow">
          <img src="https://primeirodollar.store/lovable-uploads/3158d6a9-a80e-4bc7-9145-d9812995017b.png" alt="Acessórios" class="w-full rounded-lg shadow">
          <img src="https://primeirodollar.store/lovable-uploads/5aa0c82c-e71d-41b1-8e1a-23a526064b7f.png" alt="Brocas" class="w-full rounded-lg shadow">
          <img src="https://primeirodollar.store/lovable-uploads/63b6ffce-fe37-4b93-9512-b95c755be802.png" alt="Kit Completo" class="w-full rounded-lg shadow">
        </div>
      </div>
    </div>
